...
Cette section est dédiée aux utilisateurs de Windows uniquement. Si vous n'êtes pas sur Windows, jetez un œil aux pages [Formater la SD (Linux)](formatting-sd-\(linux\)) ou [Formater la SD (Mac)](formatting-sd-\(mac\)).
