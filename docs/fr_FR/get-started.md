...
Avant de commencer ce guide, nous verrons si un custom firmware est déjà installé et vérifierons la version actuelle du système de votre console.

### Section I - Vérification de la présence d’un CFW

1. Éteignez votre console
2. Insérez votre carte SD dans votre console
3. Maintenez le bouton (Select)
4. Allumez votre console tout en maintenant le bouton (Select) enfoncé
5. Si vous ne voyez pas de menu personnalisé (votre console démarre juste sur le menu HOME), vous pouvez passer à la section suivante
...
### Section II - Vérification de la version du système

1. Lancez les Paramètres de la console
2. La version de votre système sera affichée en bas à droite de l'écran du haut (par ex. "Ver. 11.17.0-50U")
