...
Comme les iPhones et iPads n'ont pas d'emplacement de carte SD, vous aurez besoin d'un adaptateur pour brancher votre carte SD à votre console (par ex. un adaptateur Lightning vers carte SD ou un adaptateur USB-C vers carte SD).
...
8. Attendez que votre console atteigne l'écran [Bienvenue dans l'Éditeur Mii](/images/screenshots/mset9/mii-welcome.png), puis quittez l'Éditeur Mii et retournez au menu HOME
   - Vous verrez peut-être [cet écran](/images/screenshots/mset9/mii-extdata.png), qui indique que les données nécessaires ont été créées
...
9. Lancez les paramètres du système et accédez à `Gestion des données` -> `Nintendo 3DS` -> `Logiciels` -> Réinitialiser ([image](/images/screenshots/database-reset.jpg))
...
1. Saisissez le numéro correspondant au modèle et à la version de votre console, puis appuyez sur Entrée
   ...
   - Si l'écran affiche [Not ready - check MSET9 status for more details](/images/screenshots/mset9/mset9-ish-not-ready.png) :
     ...
     - Une fois que vous avez résolu le problème, retournez à la Section I Étape 14
...
1. Lorsque vous y êtes invité, entrez la combinaison de boutons donnée sur l'écran du haut pour installer boot9strap
   ...
   - Si l'écran du haut est vide **et** que vous voyez "Crypto status - all checks passed" sur l'écran du bas, vous devrez entrer la combinaison de boutons à l'aveuglette. Appuyez sur les boutons suivants de votre console dans cet ordre :
