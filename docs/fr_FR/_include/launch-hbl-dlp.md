1. Lancez l'application Mode Téléchargement (![](/images/download-play-icon.png){height="24px" width="24px"})
2. Attendez jusqu'à ce que vous voyiez les boutons `Nintendo 3DS` et `Nintendo DS`
3. Appuyez simultanément sur (L) + (Bas sur la croix directionnelle) + (Select) pour ouvrir le menu Rosalina
4. Sélectionnez "Miscellaneous options"
5. Sélectionnez "Switch the hb. title to the current app."
...
12. Votre console devrait charger le Homebrew Launcher
    - Si votre console est bloquée sur l'écran de démarrage, il vous manque 'boot.3dsx' dans la racine de votre carte SD
